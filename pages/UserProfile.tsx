...
export function UserProfile({ userId, onClose }: UserProfileProps) {
  ...
  return (
    <div className="absolute inset-0 z-50 bg-gray-50 overflow-y-auto animate-fadeIn">
      {/* Header */}
      <div className="relative">
        {/* Cover gradient */}
        <div className="h-32 bg-gradient-to-r from-[#3C5E82] to-[#5E82AC]"></div>
        ...
        <div className="px-5 pb-5">
          <div className="flex items-end -mt-12">
            <div className="h-24 w-24 rounded-full bg-gradient-to-br from-[#3C5E82] to-[#5E82AC] flex items-center justify-center text-white font-bold text-3xl border-4 border-white shadow-lg">
              {user.name.charAt(0)}
            </div>
          </div>
        ...
        <div className="px-5 pb-5">
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
              <div className="text-2xl font-bold bg-gradient-to-r from-[#3C5E82] to-[#5E82AC] bg-clip-text text-transparent">
            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
              <div className="flex items-center justify-center h-8">
                <Award size={20} className="text-[#3C5E82]" />
              </div>
              <div className="text-xs text-gray-500 mt-1">Trojan</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="sticky top-0 z-10 bg-white border-b border-gray-200">
        <div className="flex px-5">
          ...
          >
            Posts
            {activeTab === 'posts' && (
              <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-[#3C5E82]"></div>
            )}
          </button>
          <button
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm text-gray-900">Received {user._count.receivedLikes} likes</p>
                    <p className="text-xs text-gray-500">This week</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#3C5E82] to-[#5E82AC] flex items-center justify-center flex-shrink-0">
                    <MessageSquare size={14} className="text-white" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-sm text-gray-900">Posted {user._count.posts} times</p>
