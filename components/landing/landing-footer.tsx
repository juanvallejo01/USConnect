    ...
    <footer className="border-t border-border/40 bg-background/60 px-6 py-10 backdrop-blur-xl">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 text-center sm:flex-row sm:justify-between sm:text-left">
        ...
        <nav className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-muted-foreground">
          <a href="#" className="hover:text-foreground transition-all duration-300 hover:drop-shadow-[0_0_6px_rgba(59,130,246,0.3)]">{t("terms")}</a>
          <a href="#" className="hover:text-foreground transition-all duration-300 hover:drop-shadow-[0_0_6px_rgba(59,130,246,0.3)]">{t("privacy")}</a>
          <a href="#" className="hover:text-foreground transition-all duration-300 hover:drop-shadow-[0_0_6px_rgba(59,130,246,0.3)]">{t("contact")}</a>
        </nav>
      </div>
